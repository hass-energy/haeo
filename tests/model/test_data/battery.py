...
VALID_CASES: list[ElementTestCase] = [
    {
        ...
        "expected_outputs": {
            ...
            "normal_monotonic_charge": {"type": "shadow_price", "unit": "$/kWh", "values": (0.0, 0.0, 0.0)},
            "normal_monotonic_discharge": {"type": "shadow_price", "unit": "$/kWh", "values": (0.0, 0.0, 0.0)},
            "normal_capacity_upper": {"type": "shadow_price", "unit": "$/kWh", "values": (0.0, 0.0, 0.0)},
            "normal_capacity_lower": {"type": "shadow_price", "unit": "$/kWh", "values": (0.0, 0.0, 0.0)},
        },
    },
    {
