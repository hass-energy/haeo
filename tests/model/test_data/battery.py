...
VALID_CASES: list[ElementTestCase] = [
    {
        ...
        "inputs": {
            "power": [5.0, 2.0, 0.0],  # Forced input (no efficiency loss now)
            "input_cost": 0.0,
            "output_cost": 0.0,
        },
        "expected_outputs": {
            "battery_state_of_charge": {
                "type": "soc",
                "unit": "%",
                "values": (20.0, 70.0, 90.0, 90.0),
            },
            "battery_energy_stored": {
                "type": "energy",
                "unit": "kWh",
                "values": (2.0, 7.0, 9.0, 9.0),
            },
            "battery_normal_energy_stored": {
                "type": "energy",
                "unit": "kWh",
                "values": (1.0, 6.0, 8.0, 8.0),
            },
    ...
    },
    {
        ...
        "inputs": {
            "power": [-3.0, -3.0, 0.0],  # Forced output (no efficiency loss now)
            "input_cost": 0.0,
            "output_cost": 0.0,
        },
        "expected_outputs": {
            "battery_state_of_charge": {
                "type": "soc",
                "unit": "%",
                "values": (80.0, 50.0, 20.0, 20.0),
            },
            "battery_energy_stored": {
                "type": "energy",
                "unit": "kWh",
                "values": (8.0, 5.0, 2.0, 2.0),
            },
            "battery_normal_energy_stored": {
                "type": "energy",
                "unit": "kWh",
                "values": (7.0, 4.0, 1.0, 1.0),
            },
    ...
    },
    {
        ...
        "expected_outputs": {
            ...
            "battery_undercharge_energy_in_flow": {
                "type": "shadow_price",
                "unit": "$/kWh",
                "values": (0.008, 0.01, 0.0115),
            },
            "battery_undercharge_energy_out_flow": {
                "type": "shadow_price",
                "unit": "$/kWh",
                "values": (-0.0, -0.0, 0.0005),
            },
    ...
    },
    {
        ...
        "expected_outputs": {
            ...
            "battery_undercharge_energy_in_flow": {
                "type": "shadow_price",
                "unit": "$/kWh",
                "values": (-0.0, 0.0015, -0.0),
            },
            "battery_undercharge_energy_out_flow": {
                "type": "shadow_price",
                "unit": "$/kWh",
                "values": (-0.0, 0.0005, 0.004),
            },
            "battery_undercharge_soc_max": {
                "type": "shadow_price",
                "unit": "$/kWh",
                "values": (-0.0, -0.003, -0.0),
            },
            "battery_undercharge_soc_min": {"type": "shadow_price", "unit": "$/kWh", "values": (0.0, 0.0, 0.0)},
        },
    },
