...
VALID_DATA = [
    ...
    },
    {
        ...
        "mode_input": {
            ...
            CONF_SOURCE: "Battery1",
            CONF_TARGET: "Grid1",
            CONF_MAX_POWER_SOURCE_TARGET: ["sensor.haeo_constant_power"],
            CONF_MAX_POWER_TARGET_SOURCE: ["sensor.haeo_constant_power"],
            CONF_EFFICIENCY_SOURCE_TARGET: ["sensor.haeo_constant_percentage"],
            CONF_EFFICIENCY_TARGET_SOURCE: [],
            CONF_PRICE_SOURCE_TARGET: [],
            CONF_PRICE_TARGET_SOURCE: [],
        },
