...
from custom_components.haeo.elements.node import CONF_IS_SINK, CONF_IS_SOURCE, SECTION_ADVANCED, SECTION_BASIC
...
VALID_DATA = [
    {
        ...
        "config": {
            SECTION_BASIC: {CONF_NAME: "Test Node"},
