...
from tests.scenarios.visualisation.colors import get_element_color

_LOGGER = logging.getLogger(__name__)


def plot_production_layer(ax: Any, time_values: list[Any], forecast_data: dict[str, Any]) -> None:
