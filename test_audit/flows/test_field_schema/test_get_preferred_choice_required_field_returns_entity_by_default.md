...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_get_preferred_choice_required_field_returns_entity_by_default
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_get_preferred_choice_required_field_returns_entity_by_default
  fixtures: []
  markers: []
notes:
