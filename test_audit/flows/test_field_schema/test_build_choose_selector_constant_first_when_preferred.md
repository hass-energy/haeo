...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_build_choose_selector_constant_first_when_preferred
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_build_choose_selector_constant_first_when_preferred
  fixtures: []
  markers: []
notes:
