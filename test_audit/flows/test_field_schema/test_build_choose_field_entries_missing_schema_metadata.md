...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_build_choose_field_entries_missing_schema_metadata
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_build_choose_field_entries_missing_schema_metadata
  fixtures: []
  markers: []
notes:
