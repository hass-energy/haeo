...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_convert_choose_data_entity_string_stored_as_list
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_convert_choose_data_entity_string_stored_as_list
  fixtures: []
  markers: []
notes:
