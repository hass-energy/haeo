...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_get_preferred_choice_returns_entity_for_entity_defaults
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_get_preferred_choice_returns_entity_for_entity_defaults
  fixtures: []
  markers: []
notes:
