...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_validate_choose_fields_returns_empty_for_valid_input
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_validate_choose_fields_returns_empty_for_valid_input
  fixtures: []
  markers: []
notes:
