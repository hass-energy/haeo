...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_number_selector_from_field_creates_selector
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_number_selector_from_field_creates_selector
  fixtures: []
  markers: []
notes:
