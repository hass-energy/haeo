...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_convert_choose_data_ignores_unsupported_value_types
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_convert_choose_data_ignores_unsupported_value_types
  fixtures: []
  markers: []
notes:
