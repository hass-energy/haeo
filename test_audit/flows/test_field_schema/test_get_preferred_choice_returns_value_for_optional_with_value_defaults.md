...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_get_preferred_choice_returns_value_for_optional_with_value_defaults
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_get_preferred_choice_returns_value_for_optional_with_value_defaults
  fixtures: []
  markers: []
notes:
