...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_get_choose_default_uses_nested_current_data
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_get_choose_default_uses_nested_current_data
  fixtures: []
  markers: []
notes:
