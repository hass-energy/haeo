...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_preprocess_choose_selector_input_already_normalized_passthrough
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_preprocess_choose_selector_input_already_normalized_passthrough
  fixtures: []
  markers: []
notes:
