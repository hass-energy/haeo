...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_get_choose_default_uses_current_data_entity
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_get_choose_default_uses_current_data_entity
  fixtures: []
  markers: []
notes:
