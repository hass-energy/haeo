...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_build_choose_selector_entity_first_by_default
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_build_choose_selector_entity_first_by_default
  fixtures: []
  markers: []
notes:
