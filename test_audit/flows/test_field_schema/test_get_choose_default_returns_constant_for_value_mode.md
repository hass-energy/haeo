...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_get_choose_default_returns_constant_for_value_mode
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_get_choose_default_returns_constant_for_value_mode
  fixtures: []
  markers: []
notes:
