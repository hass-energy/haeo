...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_build_choose_selector_creates_normalizing_choose_selector
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_build_choose_selector_creates_normalizing_choose_selector
  fixtures: []
  markers: []
notes:
