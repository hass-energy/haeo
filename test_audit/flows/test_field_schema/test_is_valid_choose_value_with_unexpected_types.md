...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_is_valid_choose_value_with_unexpected_types
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_is_valid_choose_value_with_unexpected_types
  fixtures: []
  markers: []
notes:
