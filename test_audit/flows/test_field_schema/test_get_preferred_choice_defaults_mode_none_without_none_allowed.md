...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_get_preferred_choice_defaults_mode_none_without_none_allowed
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_get_preferred_choice_defaults_mode_none_without_none_allowed
  fixtures: []
  markers: []
notes:
