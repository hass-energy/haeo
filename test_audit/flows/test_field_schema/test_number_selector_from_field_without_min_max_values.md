...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_number_selector_from_field_without_min_max_values
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_number_selector_from_field_without_min_max_values
  fixtures: []
  markers: []
notes:
