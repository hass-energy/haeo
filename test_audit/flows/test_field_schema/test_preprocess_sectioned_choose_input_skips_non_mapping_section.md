...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_preprocess_sectioned_choose_input_skips_non_mapping_section
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_preprocess_sectioned_choose_input_skips_non_mapping_section
  fixtures: []
  markers: []
notes:
