...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_build_choose_selector_required_has_no_none_choice
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_build_choose_selector_required_has_no_none_choice
  fixtures: []
  markers: []
notes:
