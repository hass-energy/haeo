...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_preprocess_sectioned_choose_input_nests_and_normalizes
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_preprocess_sectioned_choose_input_nests_and_normalizes
  fixtures: []
  markers: []
notes:
