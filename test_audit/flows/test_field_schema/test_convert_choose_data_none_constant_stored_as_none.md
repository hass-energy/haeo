...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_convert_choose_data_none_constant_stored_as_none
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_convert_choose_data_none_constant_stored_as_none
  fixtures: []
  markers: []
notes:
