...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_validate_choose_fields_skips_excluded_fields
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_validate_choose_fields_skips_excluded_fields
  fixtures: []
  markers: []
notes:
