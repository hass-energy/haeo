...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_normalizing_choose_selector_call_passthrough_already_normalized
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_normalizing_choose_selector_call_passthrough_already_normalized
  fixtures: []
  markers: []
notes:
