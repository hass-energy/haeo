...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_convert_sectioned_choose_data_to_config_handles_non_mapping_section
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_convert_sectioned_choose_data_to_config_handles_non_mapping_section
  fixtures: []
  markers: []
notes:
