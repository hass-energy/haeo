...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_get_preferred_choice_uses_current_data_entity_list
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_get_preferred_choice_uses_current_data_entity_list
  fixtures: []
  markers: []
notes:
