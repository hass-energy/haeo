...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/flows/test_field_schema.py::test_build_entity_selector_without_include_entities
  source_file: tests/flows/test_field_schema.py
  test_class: ''
  test_function: test_build_entity_selector_without_include_entities
  fixtures: []
  markers: []
notes:
