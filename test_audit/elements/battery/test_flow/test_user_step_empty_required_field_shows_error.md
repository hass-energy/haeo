...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/elements/battery/test_flow.py::test_user_step_empty_required_field_shows_error
...
notes:
  ...
  decision_rationale: Combine into shared flow validation tests.
---
...
Consider consolidating required-field validation tests.
