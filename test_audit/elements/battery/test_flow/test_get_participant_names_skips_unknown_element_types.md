...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/elements/battery/test_flow.py::test_get_participant_names_skips_unknown_element_types
  ...
  markers: []
notes:
  behavior: Skips participant subentries with unknown element types.
