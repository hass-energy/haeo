...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/elements/battery/test_adapter.py::test_available_returns_true_with_constant_values
  ...
  markers: []
notes:
  behavior: Availability succeeds when config values are constants.
  redundancy: Distinct constant-value path.
