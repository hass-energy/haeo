...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/elements/battery_section/test_adapter.py::test_available_returns_true_when_sensors_exist
  ...
  markers: []
notes:
  behavior: Battery section availability succeeds when required sensors exist.
...
No overlap with missing-sensor case.
