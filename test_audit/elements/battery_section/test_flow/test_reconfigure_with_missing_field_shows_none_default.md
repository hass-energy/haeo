...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/elements/battery_section/test_flow.py::test_reconfigure_with_missing_field_shows_none_default
  ...
  markers: []
notes:
  behavior: Missing optional fields default to None during reconfigure.
...
Missing optional fields default to None on reconfigure.
