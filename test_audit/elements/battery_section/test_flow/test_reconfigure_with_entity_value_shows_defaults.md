...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/elements/battery_section/test_flow.py::test_reconfigure_with_entity_value_shows_defaults
  source_file: tests/elements/battery_section/test_flow.py
  test_class: ''
  test_function: test_reconfigure_with_entity_value_shows_defaults
  fixtures: []
  markers: []
notes:
