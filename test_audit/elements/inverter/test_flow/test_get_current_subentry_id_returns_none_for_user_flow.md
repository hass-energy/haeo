...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/elements/inverter/test_flow.py::test_get_current_subentry_id_returns_none_for_user_flow
  source_file: tests/elements/inverter/test_flow.py
  test_class: ''
  test_function: test_get_current_subentry_id_returns_none_for_user_flow
  fixtures: []
  markers: []
notes:
