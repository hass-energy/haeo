...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/elements/inverter/test_adapter.py::test_available_returns_true_when_sensors_exist
  ...
  markers: []
notes:
  behavior: Availability succeeds when required limit sensors exist.
