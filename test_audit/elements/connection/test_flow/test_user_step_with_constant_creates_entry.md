...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/elements/connection/test_flow.py::test_user_step_with_constant_creates_entry
  ...
  markers: []
notes:
  behavior: User flow with constants creates entry storing constant values.
  redundancy: Core connection flow behavior.
