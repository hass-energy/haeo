...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/elements/solar/test_flow.py::test_reconfigure_with_deleted_connection_target
...
Deleted connection targets are preserved in reconfigure options.
