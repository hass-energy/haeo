...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/entities/test_haeo_number.py::test_horizon_start_returns_none_without_forecast
  ...
  markers: []
notes:
  behavior: horizon_start returns None when forecast attributes missing.
  redundancy: Companion to horizon start with forecast.
