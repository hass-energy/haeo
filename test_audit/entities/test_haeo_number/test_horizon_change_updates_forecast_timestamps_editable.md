...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/entities/test_haeo_number.py::test_horizon_change_updates_forecast_timestamps_editable
...
notes:
  ...
  decision_rationale: Keep. Prevents regressions in state updates.
---

# Behavior summary

Horizon change triggers a state write with updated forecast timestamps.
