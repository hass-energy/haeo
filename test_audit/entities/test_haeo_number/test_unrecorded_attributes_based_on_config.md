...
meta:
  nodeid: tests/entities/test_haeo_number.py::test_unrecorded_attributes_based_on_config
  ...
  markers: []
notes:
  behavior: Recorder filtering respects record_forecasts configuration.
  redundancy: Specific to recorder filtering.
  decision_rationale: Keep. Ensures forecasts are recorded or excluded correctly.
---
