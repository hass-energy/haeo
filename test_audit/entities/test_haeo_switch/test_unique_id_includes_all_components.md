...
parameterized:
  ...
  cases: []
meta:
  nodeid: tests/entities/test_haeo_switch.py::test_unique_id_includes_all_components
  ...
  markers: []
notes:
  behavior: Unique ID includes entry ID, subentry ID, and field name.
...
Unique ID combines entry, subentry, and field key.
