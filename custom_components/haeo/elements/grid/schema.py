...
CONF_DEMAND_CURRENT_ENERGY_IMPORT: Final = "demand_current_energy_import"
CONF_DEMAND_CURRENT_ENERGY_EXPORT: Final = "demand_current_energy_export"
...
class GridConfigSchema(TypedDict):
    ...
    demand_current_energy_import: NotRequired[str | float]  # Entity ID or constant kWh
    demand_current_energy_export: NotRequired[str | float]  # Entity ID or constant kWh
...
class GridConfigData(TypedDict):
    ...
    demand_current_energy_import: NotRequired[float]  # Demand energy already used (kWh)
    demand_current_energy_export: NotRequired[float]  # Demand energy already used (kWh)
