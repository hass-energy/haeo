...
class InverterSubentryFlowHandler(ElementFlowMixin, ConfigSubentryFlow):
    ...
    async def _async_step_user(self, user_input: dict[str, Any] | None) -> SubentryFlowResult:
        ...
        input_fields = adapter.inputs(cast("InverterConfigSchema", subentry_data or {}))
    ...
    def _build_schema(
        ...
        for field_info in input_fields:
            is_optional = (
                field_info.field_name in InverterConfigSchema.__optional_keys__ and not field_info.force_required
            )
    ...
    def _validate_user_input(self, user_input: dict[str, Any] | None) -> dict[str, str] | None:
        ...
        input_fields = adapter.inputs(cast("InverterConfigSchema", {}))
