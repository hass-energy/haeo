...
class InverterSubentryFlowHandler(ElementFlowMixin, ConfigSubentryFlow):
    ...
    def _build_step1_schema(
        ...
        for field_info in INPUT_FIELDS:
            ...
            marker, selector = build_entity_schema_entry(
                field_info,
                config_schema=InverterConfigSchema,
    ...
    def _finalize(self, config: InverterConfigSchema) -> SubentryFlowResult:
    ...
    def _validate_configurable_values(
        ...
        for field_info in INPUT_FIELDS:
            ...
            is_required = field_name not in InverterConfigSchema.__optional_keys__ or field_info.default is None
