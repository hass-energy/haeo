    ...
    return vol.Schema(
        {
            ...
            vol.Required(CONF_MAX_POWER_DC_TO_AC): build_entity_selector_with_configurable(
                _get_field(CONF_MAX_POWER_DC_TO_AC),
                exclude_entities=exclusion_map.get(CONF_MAX_POWER_DC_TO_AC, []),
            ),
            vol.Required(CONF_MAX_POWER_AC_TO_DC): build_entity_selector_with_configurable(
