...
def available(config: ConnectionConfigSchema, *, hass: HomeAssistant, **_kwargs: Any) -> bool:
...
def outputs(
    name: str, model_outputs: Mapping[str, Mapping[ModelOutputName, OutputData]], _config: ConnectionConfigData
