...
from .calendar_value import CalendarValue
...
type SchemaValueKind = Literal["entity", "constant", "none", "calendar"]

type SchemaValue = EntityValue | ConstantValue | NoneValue | CalendarValue
