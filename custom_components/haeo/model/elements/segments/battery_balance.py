...
class BatteryBalanceSegment(Segment):
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize balance segment variables.
        ...
        Args:
            ...
            spec: Battery balance segment specification.
        ...
        self.unmet_demand = solver.addVariables(
            n_periods,
            lb=0,
            name_prefix=f"{segment_id}_unmet_demand_",
            out_array=True,
        )
        self.absorbed_excess = solver.addVariables(
            n_periods,
            lb=0,
            name_prefix=f"{segment_id}_absorbed_excess_",
            out_array=True,
        )
    ...
    def balance_power_down(self) -> OutputData:
        ...
        return OutputData(
            ...
            unit="kW",
            values=self._solver.vals(self._power_down),
            direction="+",
        )
    ...
    def balance_power_up(self) -> OutputData:
        ...
        return OutputData(
            type=OutputType.POWER_FLOW,
            unit="kW",
            values=self._solver.vals(self._power_up),
            direction="-",
        )
    ...
    def balance_unmet_demand(self) -> OutputData:
        ...
        return OutputData(
            type=OutputType.POWER_FLOW,
            unit="kW",
            values=self._solver.vals(self.unmet_demand),
        )
    ...
    def balance_absorbed_excess(self) -> OutputData:
        ...
        return OutputData(
            type=OutputType.POWER_FLOW,
            unit="kW",
            values=self._solver.vals(self.absorbed_excess),
        )
