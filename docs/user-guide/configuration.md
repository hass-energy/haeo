...
**Name**: A unique name for your energy hub (e.g., "Home Energy System")
...
**Horizon Hours**: The optimization time horizon in hours (1-168).
...
**Period Minutes**: The time resolution for optimization in minutes (1-60).
