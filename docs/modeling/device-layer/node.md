...
| ---------------------------- | ------ | --------- | --------------------------------------------- |
| `power_balance`              | \$/kW  | Real-time | Shadow price of power at this node (per kW)   |
| `power_balance_energy_price` | \$/kWh | Real-time | Shadow price of power at this node (per kWh)  |
