...
- **[Battery balance segment](battery-balance.md)** for section ordering in multi-section batteries.
...
- **[Demand pricing segment](demand-pricing.md)** for peak demand window charges.
